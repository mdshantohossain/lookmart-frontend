          ...
          : categories.map((category, i) => (
              <Link
                ...
                <div className="relative w-24 h-24 md:w-32 md:h-32 mb-4">
                  ...
                  <div className="absolute inset-0 rounded-full transition-all duration-500 group-hover:bg-primary/10 group-hover:scale-110 group-hover:rotate-6" />
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-5">
                    <Image
                      ...
                      width={80}
                      height={80}
                      className="object-fit rounded-full transition-transform duration-500 group-hover:scale-110"
                    />
                  </div>
                ...
                <div className="text-center space-y-1">
                  <h3 className="text-sm md:text-base font-bold group-hover:text-primary transition-colors truncate w-full px-2">
                    {category.name}
                  </h3>
                </div>

                {/* Bottom Indicator Line */}
                <div className="mt-2 w-0 h-1 bg-primary rounded-full transition-all duration-300 group-hover:w-22" />
              </Link>
            ))}
      </div>
    </section>
